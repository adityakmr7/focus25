...
const SwitchThemeButton: React.FC<SwitchThemeButtonProps> = ({ style, contentContainerStyle }) => {
    ...
    const isInvisible = useDerivedValue(() => {
        return reanimatedProgressValue.value > 0 && reanimatedProgressValue.value < 1;
    });
