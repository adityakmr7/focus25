...
const SettingsScreen = () => {
  ...
  // Modal states
  const [focusDurationModalVisible, setFocusDurationModalVisible] =
    useState(false);
  const [breakDurationModalVisible, setBreakDurationModalVisible] =
    useState(false);
  const [themeModalVisible, setThemeModalVisible] = useState(false);

  // Get settings from store
  const { focusDuration, breakDuration, setFocusDuration, setBreakDuration } =
    useSettingsStore();
