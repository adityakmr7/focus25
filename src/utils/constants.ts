...
export const musicTracks: MusicTrack[] = [
  {
    ...
    source:
      'https://zcscxzzuwwkjfdtjgozi.supabase.co/storage/v1/object/public/songs//rain-instrument.mp3',
    color: '#10B981',
    isLocal: true,
  },
  {
    ...
    source:
      'https://zcscxzzuwwkjfdtjgozi.supabase.co/storage/v1/object/public/songs//ocean-instrumental.mp3',
    color: '#3B82F6',
    isLocal: true,
  },
  {
    ...
    source:
      'https://zcscxzzuwwkjfdtjgozi.supabase.co/storage/v1/object/public/songs//alpha-waves-instrument.mp3',
    color: '#8B5CF6',
    isLocal: true,
  },
];
