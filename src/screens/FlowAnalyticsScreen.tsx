...
const FlowAnalyticsScreen: React.FC<FlowAnalyticsScreenProps> = ({
  navigation,
}) => {
  ...
  const getFlowAdvice = () => {
    const { flowIntensity, distractionCount, consecutiveSessions } =
      flowMetrics;
    ...
    if (flowIntensity === 'high') {
      return {
        ...
        advice:
          "You're experiencing deep flow. Consider extending your sessions slightly to maximize this state.",
        tips: [
      ...
      return {
        ...
        advice:
          "You're developing good focus habits. A few tweaks can help you reach deeper flow states.",
        tips: [
      ...
      return {
        ...
        advice:
          'Everyone starts somewhere. Small, consistent sessions will build your focus muscle.',
        tips: [
    ...
    return (
      ...
      >
        ...
        <View style={styles.insightContent}>
          ...
          <Text
            style={[styles.insightSubtitle, { color: theme.textSecondary }]}
          >
            {subtitle}
          </Text>
        </View>
  ...
  const TipCard: React.FC<{ tip: string; index: number }> = ({
    tip,
    index,
  }) => {
