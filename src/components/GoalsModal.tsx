            ...
            <View
              style={[
                styles.progressFill,
                {
                  ...
                  backgroundColor: goal.isCompleted ? '#10B981' : categoryInfo.color,
                }
              ]}
            />
          </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.categoryScroll}>
            {goalCategories.map((category) => (
              <TouchableOpacity
                ...
                style={[
                  styles.categoryChip,
                  formData.category === category.key && { backgroundColor: category.color + '20' }
                ]}
      ...
      <View style={styles.formRow}>
            ...
            {goalTypes.map((type) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  formData.type === type.key && { backgroundColor: theme.accent + '20' }
                ]}
                onPress={() => setFormData({ ...formData, type: type.key })}
              >
                <Text style={[
                  styles.typeButtonText,
                  { color: formData.type === type.key ? theme.accent : theme.textSecondary }
                ]}>
                  {type.label}
                </Text>
              </TouchableOpacity>
        ...
        <View style={[styles.formGroup, { flex: 1 }]}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setFormData({ ...formData, target: parseInt(text) || 0 })}
            placeholder="0"
            placeholderTextColor={theme.textSecondary}
            ...
            <>
              ...
              <View style={styles.tabs}>
                <TouchableOpacity
                  style={[
                    styles.tab,
                    selectedTab === 'active' && { backgroundColor: theme.accent + '20' }
                  ]}
                  onPress={() => setSelectedTab('active')}
                >
                  <Text style={[
                    styles.tabText,
                    { color: selectedTab === 'active' ? theme.accent : theme.textSecondary }
                  ]}>
                ...
                <TouchableOpacity
                  style={[
                    styles.tab,
                    selectedTab === 'completed' && { backgroundColor: '#10B981' + '20' }
                  ]}
                  onPress={() => setSelectedTab('completed')}
                >
                  <Text style={[
                    styles.tabText,
                    { color: selectedTab === 'completed' ? '#10B981' : theme.textSecondary }
                  ]}>
