...
const onboardingSteps: OnboardingStep[] = [
  {
    ...
    description:
      'Transform your productivity with scientifically-backed focus techniques and personalized insights.',
    image:
  ...
  },
  {
    ...
    description:
      "Our intelligent timer adapts to your flow state, extending sessions when you're in deep focus and suggesting breaks when needed.",
    image:
  ...
  },
  {
    ...
    description:
      'Get detailed insights into your focus patterns, peak performance times, and productivity trends.',
    image:
  ...
  },
  {
    ...
    description:
      'Set meaningful goals, track your progress, and celebrate achievements with our comprehensive goal system.',
    image:
  ...
  },
  {
    ...
    description:
      "You're all set! Let's begin your first focus session and start building incredible productivity habits.",
    image:
...
export const OnboardingFlow: React.FC<OnboardingFlowProps> = ({
  ...
  const animatedSlideStyle = useAnimatedStyle(() => ({
    transform: [
      {
        translateX: interpolate(slideAnimation.value, [0, 1], [0, -width]),
      },
    ],
  }));
      ...
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        ...
        >
          ...
          <View style={styles.textContent}>
            ...
            <Text
              style={[styles.stepSubtitle, { color: currentStepData.color }]}
            >
